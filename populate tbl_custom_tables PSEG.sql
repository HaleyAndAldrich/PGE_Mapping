...
select 5036806,'generic','tbl_All_Results',  null, 'SO','N83SP NJ Ft', 'Select * INTO [EQuIS_Reporting].','  FROM [EQuIS].[rpt].[fn_HAI_EQUIS_Results_v3]( @facility_id, @unit, null, @coord_type, null,  @matrix)'
	union
select   
	5036806
	,'location'
